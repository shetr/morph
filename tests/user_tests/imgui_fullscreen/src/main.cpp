...
public:
    ...
    void RunIter(f64 lastIterTime, f64 lastFrameTime) override {
        ...
        // draw ui
        {
            ...
            ImGui::Begin("fullscreen imgui test", (bool*)0, flags);

            ImGui::BeginChild("settings", ImVec2(350, 0), false);
            ...
            ImGui::BeginChild("scene", ImVec2(0, 0), false);
